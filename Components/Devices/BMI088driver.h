...
#if HERO == ONE
// ���ֶ��޸�
#define GxOFFSET -0.000764323166f
#define GyOFFSET -0.00459688576f
#define GzOFFSET 0.000461151969f
#define gNORM 9.66921997f
#else
#define GxOFFSET -0.000687493477f
#define GyOFFSET 0.00149335922f
#define GzOFFSET 0.00109069317f
#define gNORM 9.62515831f
#endif
